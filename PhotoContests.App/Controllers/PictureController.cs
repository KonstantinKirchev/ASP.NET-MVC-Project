    ...
    public class PictureController : BaseController
    {
        ...
        public ActionResult UploadPicture(AddPictureBindingModel model)
        {
            ...
            if (model.Picture != null && model.Picture.ContentLength > 0)
            {
                ...
                using (var filestream = new FileStream(HttpContext.Server.MapPath("~/client_secret.json"), FileMode.Open, FileAccess.Read))
                {
                    credential = GoogleWebAuthorizationBroker.AuthorizeAsync(
                        ...
                        new FileDataStore(HttpContext.Server.MapPath("~/Contests"))).Result;
                }
